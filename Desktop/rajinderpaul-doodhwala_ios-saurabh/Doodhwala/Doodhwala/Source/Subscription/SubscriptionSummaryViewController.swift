...
class SubscriptionSummaryViewController: UIViewController {
    ...
    @IBOutlet weak var typeOfDeliverValueLabel: UILabel!
    @IBOutlet weak var typeofDeliverLabel: UILabel!
    @IBOutlet weak var Unitlabe: UILabel!
    ...
    @IBOutlet weak var DeliveryOnLabel: UILabel!
...
//            promoCodeButtonUnderline.isHidden = true
            ...
            typeofDeliverLabel.text =  " Delivery On : "
            DeliveryOnLabel.isHidden = false
        }
        ...
        if let productSubDetailsDict = productSubDetailsDict {
            ...
            if subscriptionView {
                if let subscriptionId = productSubDetailsDict["subscriptionId"] as? Int {
                    if   let subscriptionfrequency  = productSubDetailsDict["deliveryFrequency"] as? Int {
                        if  subscriptionfrequency ==  4 &&  subscriptionId == 0 {
            ...
            if let value = productSubDetailsDict["startDate"] as? String {
                ...
                DeliveryOnLabel.text = s
                
                
                
                //     DeliveryOnLabel.text = productSubDetailsDict["startDate"] as! String
            }
            Unitlabe.text =  productSubDetailsDict["productUnit"] as? String
            typeOfDeliverValueLabel.text =  productSubDetailsDict["scheduleText"] as? String
...
extension SubscriptionSummaryViewController {
                ...
                if let responseDict = responseDict {
                    ...
                    if let status = responseDict["status"] as? String {
                        ...
                        if status == "000000" {
                            ...
                            if let value = responseDict["net_price"] as? Double {
                                //  self.priceLabel.text = "\(value)"
                                self.priceLabel.text =  "₹ " + String(format: "%.2f", value)
                                
                            }
                            //                                                        if   let productUnit = responseDict["productUnit"] as? String {
                            //
                            //                                                                self.Unitlabe.text =  productUnit
                            //                                                            }
    ...
    fileprivate func getSubscriptionParameters() -> [String : Any]? {
        ...
        if let productDict = productSubDetailsDict, let productId = productDict["productId"] as? Int, let userId = UserManager.defaultManager.userDict?["user_id"] as? Int {
            ...
            let textfortype =  productDict["type"] as! String
            ...
            parameters = ["isUpdate": isUpdate, "subscription_id": subscriptionId, "user_id": userId, "product_id": productId, "start_date": startDate, "type": textfortype , "quantity": quanity, "subscription_type": subscriptionType, "delivery_frequency": deliveryFrequency, "alternate": alternateDaySelected,  "is_ring_bell": ringBell, "nice_to_have_req": request]
    ...
    fileprivate func getSingleOrderParameters() -> [String : Any]? {
        ...
        if let productDict = productSubDetailsDict, let productId = productDict["productId"] as? Int, let userId = UserManager.defaultManager.userDict?["user_id"] as? Int {
            ...
            parameters = ["isUpdate": isUpdate, "subscription_id": subscriptionId, "user_id": userId, "product_id": productId, "start_date": startDate, "type": "One Time", "quantity": quanity, "subscription_type": subscriptionType , "delivery_frequency": 3, "alternate": alternateDaySelected,  "is_ring_bell": ringBell, "nice_to_have_req": request]
