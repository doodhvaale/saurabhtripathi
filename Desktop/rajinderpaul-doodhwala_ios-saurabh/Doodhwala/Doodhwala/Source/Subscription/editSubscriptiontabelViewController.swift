...
extension editSubscriptiontabelViewController {
    ...
    @IBAction func submitChangeQuantityAction(_ sender: UIButton) {
        ...
        if let productDict = productDict, let subscriptionId = idValue as? [Int] {
            ...
            for  m in productDict {
                       if let old = m["quantity"] as? Int {
            ...
            for k in editSubscriptiontabelViewController.product {
                
                if let new = k.change as? Int {
                                ...
                                if status == "000000" {
                                    ...
                                    let okAction = UIAlertAction(title: "OK", style: .default, handler: { (action) in
                                        self.dismiss(animated: true, completion: {
                                            ...
                                            func  getSubsctionDetailsOndate(date: Date) {
