...
class APIManager {
    ...
    func notification(parameters: [String: Any], completionHandler: @escaping ([String: Any]?) -> Void) {
        
        Alamofire.request(APIRouter.notification(parameters)).validate().responseJSON { (response) in
    ...
    func fcmtoken(parameters: [String: Any], completionHandler: @escaping ([String: Any]?) -> Void) {
        
        Alamofire.request(APIRouter.fcmtoken(parameters)).validate().responseJSON { (response) in
    ...
    func notifyme(parameters: [String: Any], completionHandler: @escaping ([String: Any]?) -> Void) {
        
        Alamofire.request(APIRouter.notifyme(parameters)).validate().responseJSON { (response) in
    ...
    func contactus(parameters: [String: Any], completionHandler: @escaping ([String: Any]?) -> Void) {
        
        Alamofire.request(APIRouter.contactus(parameters)).validate().responseJSON { (response) in
    ...
    func mysubscription(parameters: [String: Any] , completionHandler: @escaping ([String: Any]?) -> Void) {
        
        Alamofire.request(APIRouter.mysubscription(parameters)).validate().responseJSON { (response) in
