...
//static let baseURLString = "http://doodhvale.in/dv/doodhvale/api/web/v3/" //production
//static let baseURLString = "http://doodhvale.in/stage_dvale/doodhvale/api/web/v3/"
static let baseURLString = "http://doodhvale.in/dev/doodhvale/api/web/v3/" // dev build

    static let baseURLStringForResource = "http://doodhvale.in"
       case getVuePaymentUrl(String)
    ...
    case mysubscription([String: Any])
   ...
   case notification([String: Any])
    ...
    func asURLRequest() throws -> URLRequest {
        ...
        let params: ([String: Any]?) = {
            ...
            case .getVuePaymentUrl(let userId):
          ...
          case  .mysubscription(let parameters):
            return parameters
            ...
            case .notifyme(let parameters):
                return parameters
                case .contactus(let parameters):
                  return parameters
                
                 case .notification(let parameters):
                   return parameters
                case.fcmtoken(let parameters):
                  return parameters
        ...
        let url: URL = {
            ...
            case . getVuePaymentUrl:
                relativePath = "accounts/get-payment-url-for-app"
                ...
                case .notifyme:
                            relativePath = "users/invoke-user-action"
              case  .mysubscription:
                     relativePath = "subscriptions/all-subscription-list"
                ...
                case .notification :
                  relativePath  =  "users/invoke-user-action"
               case .fcmtoken :
                relativePath  =    "users/update-user-fcm-token-id"
            }
